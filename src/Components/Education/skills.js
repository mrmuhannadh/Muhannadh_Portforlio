...
import dart from "../../Source/Logo/Languages/dart.png";
...
import flutter from "../../Source/Logo/FrameWorks/flutter.png";

const Skills = () => {
  const images = [java, c, python, js, html, css, php, mysql, dart];
  const imagesFrame = [reactL, node, spring, boot, code, azure, ang, flutter];
  return (
    <div>
      <div className="langs">
        <div className="row">
