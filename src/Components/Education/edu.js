  ...
  return (
    <div className="eduSection">
      ...
      <div className="container eduSet">
        ...
        <div className="row">
          <div
            className="col-md-4 myBox"
            data-aos="fade-right"
            data-aos-delay="100"
          >
            <img src={azhar} alt="scl logo" className="sclLogo" />
            Ordinary Level - Al-Azhar National School Dehianga, Kandy
            <br />
            Results: 3As 2Bs 4Cs
          </div>
          <div className="col-md-4 myBox" data-aos="fade-up">
            <img src={almanar} alt="scl logo" className="sclLogo" />
          ...
          <div
            ...
            data-aos-delay="100"
          >
            <img src={uor} alt="scl logo" className="sclLogo" />
